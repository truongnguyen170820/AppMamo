class AppConstants {
  ...
  static const String PREF_DEVICE_TOKEN= "DEVICE_TOKEN";
  static const String PREF_DEVICE_ID= "DEVICE_ID";

  static const int DEVICE_TYPE_IPHONE = 1;
  static const int DEVICE_TYPE_ANDROID = 0;

  static final String HIVE_USER_BOX = "hive_user";
  static final String HIVE_MEMBER_DATA = "hive_member_data";
  static final String HIVE_TASK_BOX = "hiv_task";
  static final String HIVE_TASK_DATA = "hive_task_data";
  ...
  static final String KEY_CHECK_PASSWORD = "key_check_password";
  static final String KEY_SOUND_ENABLE = "key_sound_enable";
