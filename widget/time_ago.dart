...
String formatTimeExercise(String time,{String format = "dd/MM/yyyy HH:mm:ss"}){
  var stape = DateFormat(format).parse(time, false);
  DateFormat dateFormat = DateFormat("dd/MM/yyyy");
  String timeFormat = dateFormat.format(stape);
  return timeFormat;
}
String formatTimeTraining(String time){
  ...
  String formatTimeStart(String time){
  var stape = DateFormat("dd/MM/yyyy HH:mm:ss").parse(time, false);
  DateFormat dateFormat = DateFormat("HH:mm:ss");
  String timeFormat = dateFormat.format(stape);
  return timeFormat;
...
String formatDateTimeStart(String time){
  var stape = DateFormat("dd/MM/yyyy HH:mm:ss").parse(time, false);
  DateFormat dateFormat = DateFormat("dd/MM/yyyy");
  String timeFormat = dateFormat.format(stape);
  return timeFormat;}
